...
public class RobotClient 
{
    ...
    public boolean isConnected() 
    {
        ...
        else return false;  // Vil angiveligt sidde fast i true ind til ny socket laves.
    }
