...
public class Main {
    ...
    private void RobCli(String ip, int port) {
        ...
        do {
            try {
                ...
                try {
                    ...
                    System.out.println("Fejl client connect timeout");
                }
            ...
            } catch(Exception e){System.out.println("Fejl ved forbindelse et sted\n"); /*
        ...
        switch (senddata) {
            ...
            case 11:
                ...
                try {
                    ...
                    System.out.println("Null happened \"" + Send11 + "\"");
                }
                System.out.println("Har sendt : " + Send11);
                break;
        }
        int senddata1;
        System.out.println("\nVælg 1. for at stoppe, 2 for at indtaste mere.\n");
        ...
        robotClient.disconnect();
        System.out.println("\nRobstatus er nu : " +robotClient.isConnected()+"\n");
